...
# ============================================================
# SAKILA PRICE ELASTICITY ANALYSIS
# ============================================================
...
# Demand proxy:
# rentals per available inventory copy

df["inventory_copies"] = df["inventory_copies"].replace(
    0,
    np.nan
)
...
# ============================================================
# 8. CALCULATE CATEGORY-SPECIFIC ELASTICITY
# ============================================================
...
for category in categories:
    ...
    if interaction not in params.index:

        # Elasticity = coefficient of ln_price
    ...
    # TEST H0:
    #
    # category-specific elasticity = 0
    #
    # z = elasticity / SE
    # --------------------------------------------------------
...
print(
    "p < 0.05 and |elasticity| > 1 -> Elastic"
)
print(
    "p < 0.05 and |elasticity| < 1 -> Inelastic"
)
print(
    "p < 0.05 and |elasticity| = 1 -> Unit elastic"
)
